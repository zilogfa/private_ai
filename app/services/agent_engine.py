...
def agent_engine_status():
    ...
    return {
        ...
        "registry_dependency_validation": True,
        "dependency_version_provenance": True,
        "registry_version_recovery": True,
        "baseline_before_controlled_failure": True,
        "build_contract_convergence": True,
        "baseline_contract_gate": True,
        "deferred_build_contract_gaps": True,
        "contract_directed_repair_scopes": True,
        "contract_progress_governance": True,
        "truthful_test_contract_convergence": True,
        "repair_mutation_authority": True,
        "protected_test_routing": True,
        "authority_constrained_candidate_recovery": True,
        "demonstration_provenance": True,
        "repair_campaign_epochs": True,
        "demonstration_repair_budget_reserve": True,
        "original_goal_contract_provenance": True,
        "acceptance_contract_reconciliation": True,
        "revision_guidance_contract_isolation": True,
        "deterministic_mutation_testing": True,
        "staged_fault_injection": True,
        "phase_model_timeout_containment": True,
